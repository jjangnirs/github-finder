    ...
    <div className="bg-gray-800 rounded-2xl p-6 border border-gray-700 shadow-xl">
      ...
      <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6">
        ...
        <div className="flex-1 text-center sm:text-left">
          ...
          {/* 바이오 */}
          {user.bio && (
            <p className="mt-3 text-gray-300 text-sm leading-relaxed">{user.bio}</p>
          )}
      ...
      <div className="mt-6 grid grid-cols-3 gap-4">
        <div className="bg-gray-700 rounded-xl p-4 text-center hover:bg-gray-600 transition-colors duration-200">
          <p className="text-2xl font-bold text-white">{formatNumber(user.followers)}</p>
          <p className="text-gray-400 text-xs mt-1">팔로워</p>
        </div>
        <div className="bg-gray-700 rounded-xl p-4 text-center hover:bg-gray-600 transition-colors duration-200">
          <p className="text-2xl font-bold text-white">{formatNumber(user.following)}</p>
          <p className="text-gray-400 text-xs mt-1">팔로잉</p>
        </div>
        <div className="bg-gray-700 rounded-xl p-4 text-center hover:bg-gray-600 transition-colors duration-200">
          <p className="text-2xl font-bold text-white">{formatNumber(user.public_repos)}</p>
          <p className="text-gray-400 text-xs mt-1">저장소</p>
        </div>
      </div>
